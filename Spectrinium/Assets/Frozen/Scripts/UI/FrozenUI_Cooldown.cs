...
[AddComponentMenu("Frozen UI/Slot Cooldown")]
public class FrozenUI_Cooldown : MonoBehaviour {
	...
	private FrozenUI_SpellInfo currentSpellInfo;
	
	/// <summary>
	/// Raises the assign spell event.
	/// </summary>
	/// <param name="spellInfo">Spell info.</param>
	public void OnAssignSpell(FrozenUI_SpellInfo spellInfo)
	{
