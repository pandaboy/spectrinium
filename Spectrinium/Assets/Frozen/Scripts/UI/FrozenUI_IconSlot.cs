...
[AddComponentMenu("Frozen UI/Icon Slot")]
public class FrozenUI_IconSlot : UIDragDropItem
{
	...
	public FrozenUI_IconSlot GetSource()
	{
		return this.sourceSlot as FrozenUI_IconSlot;
	}
	...
	public virtual bool Assign(Object source)
	{
		...
		else if (source is FrozenUI_IconSlot)
		{
			FrozenUI_IconSlot sourceSlot = source as FrozenUI_IconSlot;
	...
	public void SetIcon(Texture iconTex)
	{
		...
		if (iconTex != null && !this.iconSprite.enabled) this.iconSprite.enabled = true;
	...
	{
		return (target is FrozenUI_IconSlot);
	}
	...
	protected override void OnDragDropRelease(GameObject surface)
	{
		if (surface != null)
		{
			FrozenUI_IconSlot targetSlot = surface.GetComponent<FrozenUI_IconSlot>();
	...
	protected virtual void AttachToTemporary(GameObject temporary)
	{
		...
		FrozenUI_IconSlot slot = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(temporary, "Assets/Frozen/Scripts/UI/FrozenUI_IconSlot.cs (416,28)", this.GetType().ToString()) as FrozenUI_IconSlot;
