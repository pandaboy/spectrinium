...
[AddComponentMenu("Frozen UI/Tooltip")]
public class FrozenUI_Tooltip : MonoBehaviour
{
	...
	private static FrozenUI_Tooltip mInstance;
	...
	private void _Show()
	{
		...
		{
			bool isLeft = true;
			FrozenUI_Tooltip_AttributeRow lastAttrRow = null;
			...
			foreach (AttributeInfo info in this.mAttributes)
			{
				...
				if (isLeft)
				{
					...
					lastAttrRow = obj.GetComponent<FrozenUI_Tooltip_AttributeRow>();
